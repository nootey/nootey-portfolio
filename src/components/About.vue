    ...
    <div id="container" class="col">
      ...
      <div class="main-col col w-50">
        ...
        <div class="paragraph-text flex flex-row p-3 text-left">
          Hi! My name is Jure. I'm an Information and communication technology graduate from University in Ljubljana, Slovenia.
          I work full-time as a software engineer and part time as a freelancer offering various services.
